...
export const LIMITS = {
  ...
  DISCOVERY: {
    SEARCHES: toPositiveInt(process.env.FREE_DISCOVERY_SEARCHES, 5),
    ROWS_PER_SEARCH: toPositiveInt(process.env.FREE_DISCOVERY_ROWS_PER_SEARCH, 20),
    BONUS_ROWS: toPositiveInt(process.env.FREE_DISCOVERY_BONUS_ROWS, 20),
